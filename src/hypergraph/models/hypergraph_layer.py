...
class HypergraphConv(tf.keras.layers.Layer):
    def __init__(
        ...
        self.phi_conv = tf.keras.layers.Conv2D(self.filters, kernel_size=1, strides=1, padding='same',
                                               kernel_initializer=tf.keras.initializers.glorot_normal())
        self.A_conv = tf.keras.layers.Conv2D(self.filters, kernel_size=1, strides=1, padding='same',
                                             kernel_initializer=tf.keras.initializers.glorot_normal())
        self.M_conv = tf.keras.layers.Conv2D(self.edges, kernel_size=7, strides=1, padding='same',
                                             kernel_initializer=tf.keras.initializers.glorot_normal())
